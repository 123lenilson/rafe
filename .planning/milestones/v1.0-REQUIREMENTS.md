...
- [x] **FAKE-01**: Existe um `FakeStockRepositorio` (e Seeder) que implementa os Ports de Stock em memória
- [x] **FAKE-02**: Existe um `FakeClienteRepositorio` que implementa o Port de Clientes em memória
- [x] **FAKE-03**: Existe um `FakePagamentoRepositorio` que implementa o Port de Pagamentos em memória
...
| FAKE-01 | Fase 2 | ✓ Completo |
| FAKE-02 | Fase 2 | ✓ Completo |
| FAKE-03 | Fase 2 | ✓ Completo |
