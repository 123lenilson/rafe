...
**Estrutura esperada (concluída):**
```
app/Modules/Stock/Adapters/Saida/Fakes/FakeStockRepositorio.php
app/Modules/Stock/Adapters/Saida/Fakes/FakeStockSeeder.php
app/Modules/Clientes/Adapters/Saida/Fakes/FakeClienteRepositorio.php
app/Modules/Pagamentos/Adapters/Saida/Fakes/FakePagamentoRepositorio.php
```

**Estrutura a criar (Módulo POS):**
```
...
| 2 — Fake Adapters + GerirPedidoService | ✅ Completa | 100% |
| 3 — FinalizarVendaService | 🔲 Por iniciar | 0% |
...
*Última actualização: 2026-05-01 após conclusão da Fase 2*
