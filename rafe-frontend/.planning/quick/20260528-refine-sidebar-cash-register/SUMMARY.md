...
- Styled the badge with a light red background (`bg-red-50`), rich red text/icon color (`text-red-600`), borders matching the background color exactly (`border border-red-50`), padding (`px-2.5 py-1`), and border radius (`rounded-md`).
- Added active transition transitions (`transition-all duration-300 ease-in-out hover:bg-red-100/50`).
- Updated border styling to match the background red tone exactly (`border border-red-50`) following feedback, avoiding color tone mismatch.
