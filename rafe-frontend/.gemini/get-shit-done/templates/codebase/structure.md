...
- Usage: Reference from command with `@C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/wamp64/www/rafe/rafe-frontend/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/wamp64/www/rafe/rafe-frontend/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
