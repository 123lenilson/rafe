...
<!-- For checkpoint task examples and patterns, see @C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/references/checkpoints.md -->
...
See `C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
