...
- **Global scope**: `C:/wamp64/www/rafe/rafe-frontend/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/wamp64/www/rafe/rafe-frontend/.gemini/notes/`)
...
2. Glob `C:/wamp64/www/rafe/rafe-frontend/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (C:/wamp64/www/rafe/rafe-frontend/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/wamp64/www/rafe/rafe-frontend/.gemini/notes/` — works in any directory
