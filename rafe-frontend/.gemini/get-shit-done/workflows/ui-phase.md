...
```markdown
Read C:/wamp64/www/rafe/rafe-frontend/.gemini/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/wamp64/www/rafe/rafe-frontend/.gemini/agents/gsd-ui-checker.md for instructions.
