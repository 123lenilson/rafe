...
```
Agent(
  prompt="Read C:/wamp64/www/rafe/rafe-frontend/.gemini/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/templates/VALIDATION.md`
