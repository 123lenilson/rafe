...
```bash
INIT=$(node "C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/bin/gsd-tools.cjs" commit \
