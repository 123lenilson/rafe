...
```bash
INIT=$(node "C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/templates/spec.md.
