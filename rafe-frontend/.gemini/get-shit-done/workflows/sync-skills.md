...
INSTALL_JS_GLOBAL="C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
