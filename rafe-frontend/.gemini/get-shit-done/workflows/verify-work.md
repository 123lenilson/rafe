...
<template>
@C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/workflows/transition.md`.
...
- Follow @C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/workflows/diagnose-issues.md
