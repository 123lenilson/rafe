...
<required_reading>
@C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/references/ai-frameworks.md
@C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/wamp64/www/rafe/rafe-frontend/.gemini/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/wamp64/www/rafe/rafe-frontend/.gemini/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/wamp64/www/rafe/rafe-frontend/.gemini/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/wamp64/www/rafe/rafe-frontend/.gemini/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/wamp64/www/rafe/rafe-frontend/.gemini/agents/gsd-eval-planner.md for instructions.
